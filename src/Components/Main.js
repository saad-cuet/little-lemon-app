      ...
      <section className="section-menu">
        ...
        <div className="card__container">
          <div className="menu__card">
            <img src="./icons_assets/greek salad.png" alt="" />
          ...
          <div className="menu__card">
            <img src="./icons_assets/bruchetta.png" alt="" />
            <div className="card__title">
              <h3>Bruchetta</h3>
              <span>$14.99</span>
            </div>
      ...
      <section className="section-about">
        <div className="container grid-about">
          ...
          <div className="about-img-box">
            <img
              className="img-1"
              src="./icons_assets/Mario and Adrian A 1_small.png"
              alt="maria and adrian"
            />
            <img
              className="img-2"
              src="./icons_assets/Mario and Adrian B 1_small.png"
              alt="maria and adrian"
            />
          </div>
        </div>
